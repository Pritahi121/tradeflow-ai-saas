...
import { Zap, User, Mail, Lock, Building, AlertCircle, Loader2, CheckCircle } from 'lucide-react'
...
export default function SignupPage() {
  ...
  const handleGoogleSignUp = async () => {
    ...
    try {
      ...
      // If successful, the OAuth redirect will handle navigation
    } catch {
          ...
          <CardContent className="pt-6">
            <div className="text-center">
              ...
              <div className="space-y-2 text-sm text-gray-500">
                ...
                <p>✅ Ready to process your first PO</p>
              </div>
            </div>
          </CardContent>
        </Card>
